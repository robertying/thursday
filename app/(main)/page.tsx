...
const Home: React.FC = () => {
  return (
    <main className="prose-a:no-underline hover:prose-a:no-underline prose-h1:mb-4 prose-h2:mb-0 prose-h2:mt-0 prose-p:my-0 py-16 px-5 text-center min-h-screen flex flex-col items-center justify-center">
      <div>
        <h1>
